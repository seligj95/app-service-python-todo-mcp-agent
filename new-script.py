...
load_dotenv()
project_endpoint = "https://portaltest-resource.services.ai.azure.com/api/projects/portaltest"
...
mcp_server_url = "https://az-tda-app-q26srokagiokq.azurewebsites.net/mcp/stream"
...
with agents_client:
    ...
    message = agents_client.messages.create(
        thread_id=thread.id,
        role="user",
        content="Create a high priority todo to buy milk.",
    )
